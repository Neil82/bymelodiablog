                ...
                <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="excerpt" name="excerpt" rows="3" 
                                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('excerpt') }}</textarea>
                        @error('excerpt')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="image_position" name="image_position" required
                                    class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                <option value="top" {{ old('image_position') == 'top' ? 'selected' : '' }}>Superior</option>
                                <option value="bottom" {{ old('image_position') == 'bottom' ? 'selected' : '' }}>Inferior</option>
                                <option value="left" {{ old('image_position') == 'left' ? 'selected' : '' }}>Izquierda</option>
                                <option value="right" {{ old('image_position') == 'right' ? 'selected' : '' }}>Derecha</option>
                            </select>
                    ...
                    <div>
                        ...
                        <textarea id="content" name="content" required class="w-full">{{ old('content') }}</textarea>
                        @error('content')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
