    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Add New Language</h2>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Add a new language to your blog</p>
                </div>
        ...
        <form action="{{ route('admin.languages.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
...
<div class="mt-6 bg-yellow-50 dark:bg-yellow-900 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4">
    ...
    <div class="ml-3">
        ...
        <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
            After adding a new language, remember to:
            <ul class="list-disc list-inside mt-2 space-y-1">
                <li>Run <code class="bg-yellow-100 dark:bg-yellow-800 px-1 rounded">php artisan posts:translate</code> to create translations for existing posts</li>
                <li>Update your language selector component if needed</li>
                <li>Add translations for categories and other content</li>
            </ul>
        </div>
    </div>
</div>
