...
<head>
    ...
    <title>Términos de Servicio - ByMelodia</title>
    <meta name="description" content="Términos de servicio de ByMelodia - Condiciones de uso del sitio">
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <nav class="mb-8">
            <ol class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                ...
                <li><span>/</span></li>
                <li class="text-gray-700 dark:text-gray-300">Términos de Servicio</li>
            </ol>
        </nav>
